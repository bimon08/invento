                        ...
                        <form onSubmit={handleVerify} className="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="h-12 w-full rounded-xl border border-slate-700 bg-slate-800 px-4 text-center text-lg font-mono tracking-widest text-white placeholder:text-slate-500 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                                    maxLength={6}
